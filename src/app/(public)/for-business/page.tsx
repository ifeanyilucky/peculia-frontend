  ...
  return (
    <div className="flex flex-col bg-background overflow-hidden">
      ...
      <section className="relative pt-20 pb-24 px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute top-0 right-0 -mr-24 -mt-24 w-96 h-96 bg-secondary rounded-full blur-3xl opacity-60" />
        <div className="absolute bottom-0 left-0 -ml-24 -mb-24 w-96 h-96 bg-muted rounded-full blur-3xl opacity-60" />

        <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 text-center lg:text-left">
            <motion.div {...fadeUp}>
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-secondary text-primary text-sm font-bold mb-6">
                <Sparkles size={16} />
                The New Standard for Beauty Professionals
              </span>
              <h1 className="font-peculiar text-5xl md:text-7xl font-black text-foreground leading-[1.1] mb-8">
                Grow your <span className="text-primary">business</span> with
                Glamyad
              </h1>
              <p className="text-xl text-foreground/80 font-medium max-w-2xl mb-10 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                <Link
                  ...
                  className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-full text-lg font-bold hover:opacity-90 transition-all flex items-center justify-center gap-2 group border border-primary/20"
                >
                  Join as a Partner
                  <ArrowRight
                    size={20}
                ...
                <Link
                  href="#features"
                  className="w-full sm:w-auto px-8 py-4 bg-background text-foreground border border-border rounded-full text-lg font-bold hover:bg-muted transition-all flex items-center justify-center"
                >
                  See how it works
                </Link>
              </div>
          ...
          >
            <div className="relative w-full aspect-[4/5] max-w-[500px] mx-auto rounded-[2rem] overflow-hidden border border-border">
              <Image
              ...
              <div className="absolute bottom-6 left-6 right-6 flex flex-col gap-3">
                <div className="bg-white/90 backdrop-blur-md p-4 rounded-2xl flex items-center gap-4 border border-border">
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                variants={fadeUp}
                className="bg-card border border-border p-8 rounded-[2rem] hover:border-primary/20 transition-all group"
              >
      ...
      <section className="py-24 bg-foreground text-white overflow-hidden relative">
        <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-background to-transparent opacity-10" />
        ...
        <div className="max-w-7xl mx-auto px-6 mb-16 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            ...
            <Link
              href={ROUTES.partnersPortal}
              className="px-8 py-4 bg-primary text-white rounded-full font-bold hover:opacity-90 transition-all flex items-center gap-2 group whitespace-nowrap"
            >
              Get Started{" "}
              <ArrowRight
                size={20}
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto bg-primary rounded-[3rem] p-12 md:p-24 text-center relative overflow-hidden border border-primary/20">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link
                href={ROUTES.partnersPortal}
                className="w-full sm:w-auto px-10 py-5 bg-white text-primary rounded-full text-xl font-black hover:bg-white/90 transition-all border border-white/20"
              >
                Join Now
              </Link>
            </div>
