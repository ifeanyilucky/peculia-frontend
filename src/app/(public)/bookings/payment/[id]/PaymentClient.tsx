...
export default function PaymentClient({
    ...
    const fetchBooking = async () => {
      ...
      try {
        ...
        sileo.error({
          title: "Error",
          description:
            "Unable to load booking details. The link may be invalid.",
        });
      } finally {
        setLoading(false);
      }
    ...
    const verifyPayment = async () => {
      ...
      try {
        ...
        if (result.status === "success") {
          setBooking((prev) =>
            prev
              ? { ...prev, depositPaid: true, paymentStatus: "completed" }
              : null,
          );
          sileo.success({
        ...
        console.log(
          ...
          error?.response?.status === 401 ? "Auth required, skipping" : error,
        );
      } finally {
        setProcessing(false);
      }
  ...
  const isAlreadyPaid =
    booking.depositPaid || booking.paymentStatus === "completed";
          ...
          <div className="bg-red-50 border border-red-200 rounded-2xl p-6 mb-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-red-700 mt-1">
                This booking slot has been taken or cancelled. Please book a new
                appointment.
              </p>
              <Link href="/explore">
