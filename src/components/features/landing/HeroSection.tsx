  ...
  return (
    <section className="relative w-full overflow-hidden bg-white px-6 pt-16 lg:px-8 xl:pt-24 pb-20 mx-auto max-w-7xl">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        >
          {/* <span className="inline-flex items-center gap-2 rounded-full border border-secondary bg-white px-4 py-1.5 text-sm font-bold text-slate-700 transition-colors hover:bg-secondary/50 mb-8 cursor-pointer">
            <span className="rounded-full bg-rose-100 px-2 py-0.5 text-xs text-primary uppercase tracking-wider">
              New
            </span>
            ...
            >
              <div className="flex flex-1 items-center px-4 py-2 lg:border-r lg:border-secondary lg:py-0">
                ...
                <select
                  ...
                  className="w-full bg-transparent text-sm font-bold text-primary focus:outline-none appearance-none truncate"
                  disabled={isLoading}
                >
                  <option value="">
              ...
              <div className="flex flex-1 items-center px-4 py-2 lg:border-r lg:border-secondary lg:py-0">
                ...
                <input
                  ...
                  className="w-full bg-transparent text-sm font-bold text-primary focus:outline-none truncate"
                />
              </div>

              <button
                type="submit"
                className="flex h-12 lg:h-14 items-center justify-center gap-2 rounded-full bg-primary px-8 text-sm font-bold text-white transition-all hover:bg-primary/90 shrink-0"
              >
                Find My Pro
              </button>
            </form>
          ...
          <motion.div
            ...
            className="mt-8 flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-secondary text-sm font-bold text-foreground"
          >
