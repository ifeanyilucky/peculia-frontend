        ...
        <div className="grid lg:grid-cols-2">
          ...
          <div className="relative p-12 lg:p-16">
            <div className="relative z-10">
              <span className="text-sm font-bold uppercase tracking-widest text-glam-plum">
                For Clients
              </span>
              ...
              <ul className="mt-8 space-y-4">
                {[
                  ...
                  >
                    <CheckCircle2 size={20} className="text-glam-plum" />
                    {item}
                  </li>
                ))}
              </ul>
              <Link
                ...
                className="mt-10 inline-flex items-center rounded-full bg-glam-plum px-8 py-4 font-bold text-white transition-all hover:bg-white hover:text-slate-900"
              >
                Find a Professional <ArrowRight size={20} className="ml-2" />
              </Link>
            </div>
            {/* Background Accent */}
            <div className="absolute top-0 right-0 h-64 w-64 translate-x-1/2 -translate-y-1/2 rounded-full bg-glam-plum/10 blur-[100px]" />
          </div>
