  ...
  return (
    ...
    >
      <div className="text-left space-y-8">
        {/* Sort By */}
        <section>
          <h4 className="text-sm font-black text-glam-plum mb-4 uppercase tracking-widest">Sort by</h4>
              ...
              <button
                ...
                className={cn(
                  ...
                  sortBy === option.id
                    ...
                    : "border-glam-blush hover:border-glam-blush"
                )}
              >
                <option.icon size={20} className={sortBy === option.id ? "text-glam-plum" : "text-muted-foreground"} />
                <span className={cn("text-xs font-bold", sortBy === option.id ? "text-glam-plum" : "text-glam-charcoal")}>
                  {option.id}
                </span>
              </button>
            ))}
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h4 className="text-sm font-black text-glam-plum uppercase tracking-widest">Maximum price</h4>
            <span className="text-sm font-bold text-glam-plum">NGN {price.toLocaleString()}+</span>
          </div>
          <input
            type="range"
            min="0"
