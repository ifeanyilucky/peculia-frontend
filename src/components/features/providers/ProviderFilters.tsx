...
export default function ProviderFilters() {
  ...
  return (
    <aside className="space-y-8 bg-white p-6 rounded-2xl border border-slate-100 shadow-sm sticky top-24">
      ...
      {/* Minimum Rating */}
      <div className="space-y-4">
        <p className="text-sm font-bold text-slate-900">Minimum Rating</p>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={cn(
            ...
            currentVerified ? "bg-rose-600" : "bg-slate-200",
          )}
        >
          <div
            className={cn(
      ...
      {/* Sort By */}
      <div className="space-y-4">
        <p className="text-sm font-bold text-slate-900">Sort By</p>
        <select
          value={currentSort}
