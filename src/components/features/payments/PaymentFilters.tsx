...
export default function PaymentFilters({
  ...
  return (
    <div
      className={cn(
        "bg-white p-6 rounded-3xl border border-slate-100 space-y-6 shadow-sm",
      )}
    >
      <div className="flex items-center justify-between">
        ...
        {hasActiveFilters && (
          <button
            onClick={onClear}
            className="flex items-center gap-1 text-xs font-black uppercase tracking-widest text-rose-600 hover:text-rose-700 transition-colors"
          >
            <X size={14} />
            Clear
          </button>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className="w-full h-12 pl-4 pr-10 rounded-2xl bg-slate-50 border border-transparent text-sm font-bold text-slate-900 focus:bg-white focus:border-slate-900 transition-all outline-none cursor-pointer"
            />
            <CalendarIcon
              size={16}
